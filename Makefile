...
OBJECTS += sensors.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F401RE/TOOLCHAIN_GCC_ARM/analogin_device.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F401RE/TOOLCHAIN_GCC_ARM/hal_tick_overrides.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F401RE/TOOLCHAIN_GCC_ARM/mbed_crc_api.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F401RE/TOOLCHAIN_GCC_ARM/mbed_tz_context.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F401RE/TOOLCHAIN_GCC_ARM/qspi_api.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F401RE/TOOLCHAIN_GCC_ARM/stm32f4xx_hal_can_legacy.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F401RE/TOOLCHAIN_GCC_ARM/us_ticker.o
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1549904070.28
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1549904070.28
...
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/d/d8997a44a1d80512e068903dc3ca1dd4/Buggy/mbed_config.h
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -c
ASM_FLAGS += -Wall
